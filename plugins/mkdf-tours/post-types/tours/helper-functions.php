		...
		foreach($sections_array as $section) {
			...
			switch($section_key) {
				case 'show_info_section' :
					...
					$return_array[$section_key]['title'] = esc_html__('OVERVIEW','mkdf-tours');
					$return_array[$section_key]['id']    = 'tour-item-info-id';
					break;
				case 'show_tour_plan_section' :
					$return_array[$section_key]['icon']  = 'ion-ios-book';
					$return_array[$section_key]['title'] = esc_html__('DAY-BY-DAY PROGRAM','mkdf-tours');
				...
				case 'show_custom_section_1' :
					...
					$return_array[$section_key]['icon']  = 'ion-help-circled';
